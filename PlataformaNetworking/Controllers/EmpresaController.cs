...
namespace PlataformaNetworking.Controllers
{
    public class EmpresaController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CNPJ,RazaoSocial,Ramo,Id,Nome,Sobrenome,Email,DataNascimento,Senha,Situacao,ProfilePictureUrl")] Empresa empresa)
        {
            if (id != empresa.Id)
            {
                return NotFound();
